<template>
  ...
  <form id="post-message">
    <i @click="closePostMessage(); resetState()" class="far fa-window-close"></i>
...
export default {
  ...
  methods: {
    ...mapActions(["postMessage", "processFile", "updateMessage", "deleteMessage", "getAllMessages", "resetState"]),
